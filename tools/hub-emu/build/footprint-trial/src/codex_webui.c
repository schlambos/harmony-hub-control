...
/* FOOTPRINT TRIAL: force linker to retain shell asset arrays */
extern const void *const footprint_keep[];
static volatile const void *footprint_anchor;
static void footprint_touch(void) {
    footprint_anchor = footprint_keep[0];
}
