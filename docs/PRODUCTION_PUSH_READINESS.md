...
> This readiness analysis is dated 2026-07-31 against the
> `agent/activity-webgui` branch. An earlier on-hub `codex_webui` identity
> (`39793b19…`, 809,608 bytes) was a prior deploy. The **live product** webui
> is 906,872 bytes, md5 `6f05d649…`, SHA-256 `c400173b…`. The later 778,408-byte
> / `7bcf00bd…` Recovery rebuild is not the product; see `docs/BUILD.md` and
